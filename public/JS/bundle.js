...
exports.showSpinner = exports.showAlert = exports.hideSpinner = exports.hideAlert = void 0;
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector(".alert");
  if (el) el.parentElement.removeChild(el);
};
var hideSpinner = exports.hideSpinner = function hideSpinner() {
  var el = document.querySelector(".spinner-ele");
  if (el) el.parentElement.removeChild(el);
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 13:
          ...
          (0, _alert.hideSpinner)();
          formSubmitted = false;
          (0, _alert.showAlert)("danger", _context.t0.response.data.message);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)("danger", "Error in logout! try again.");
        case 11:
        case "end":
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"taskaction.js":[function(require,module,exports) {
"use strict";
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var formSubmitted = false;
var taskAction = exports.taskAction = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          if (res.data.status === "success" || res.status === 204) {
            (0, _alert.showAlert)("success", "Task ".concat(infoText, " successfully!"));
            window.setTimeout(function () {
              location.assign("/");
            }, 1500);
          }
  ...
  return function taskAction(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var createTaskForm = document.querySelector(".createtask_form");
var editTaskForm = document.querySelector(".edit-task_form");
var deleteTaskBtn = document.querySelectorAll(".delete-task-btn");
...
if (createTaskForm) {
  createTaskForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var name = document.getElementById("createtaskName").value;
    var description = document.getElementById("createtaskDescription").value;
...
if (deleteTaskBtn && deleteTaskBtn.length > 0) {
  deleteTaskBtn.forEach(function (btn) {
